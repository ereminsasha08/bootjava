...
public class UserTestUtil {
    ...
    public static void assertNoIdEqualsIterable(List<?> actual, List<?> expected) {
        assertThat(actual).usingRecursiveComparison().ignoringFields("id", "password").isEqualTo(expected);
    }
    ...
    public static List<User> asUsers(MvcResult mvcResult) throws IOException {
        String jsonActual = mvcResult.getResponse().getContentAsString();
    ...
    public static ResultMatcher jsonMatcher(List<?> expected, BiConsumer<List<?>, List<?>> equalsAssertion) {
        return mvcResult -> equalsAssertion.accept(asUsers(mvcResult), expected);
    }
